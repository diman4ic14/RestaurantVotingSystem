...
<%@ taglib prefix="rvs" tagdir="/WEB-INF/tags" %>
        ...
        <div class="row">
            <div class="col-5 offset-3">
                ...
                <form:form class="form-group" modelAttribute="userTo" method="post" action="${register ? 'profile/register' : 'profile'}"
                    ...
                    <rvs:inputField labelCode="user.name" name="name"/>
                    <rvs:inputField labelCode="user.email" name="email"/>
                    <rvs:inputField labelCode="user.password" name="password" inputType="password"/>
