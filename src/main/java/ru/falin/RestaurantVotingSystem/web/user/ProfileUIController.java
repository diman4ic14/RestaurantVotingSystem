...
public class ProfileUIController extends AbstractUserController {
    ...
    public String updateProfile(@Valid UserTo userTo, BindingResult result,
                                SessionStatus status, @AuthenticationPrincipal AuthorizedUser authUser) {
        if (result.hasErrors()) {
            return "profile";
        }
    ...
    public String saveRegister(@Valid UserTo userTo, BindingResult result,
        ...
        super.create(userTo);
        status.setComplete();
        return "redirect:/login?message=app.register&username=" + userTo.getEmail();
    }
}
