...
public class UserTestData {
    ...
    public static final User USER4 = new User(USER1_ID + 3, "user4", "user4@yandex.ru", "user4", Role.USER);
    public static final User USER5 = new User(USER1_ID + 4, "user5", "user5@yandex.ru", "user5", Role.USER);
    public static final User USER6 = new User(USER1_ID + 5, "user6", "user6@yandex.ru", "user6", Role.USER);
    public static final User USER7 = new User(USER1_ID + 6, "user7", "user7@yandex.ru", "user7", Role.USER);
