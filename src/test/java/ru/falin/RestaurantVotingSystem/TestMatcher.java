...
import static ru.falin.RestaurantVotingSystem.TestUtil.readListFromJsonMvcResult;
...
public class TestMatcher<T> {
    ...
    private static <T> TestMatcher<T> usingAssertions(Class<T> clazz, BiConsumer<T, T> assertion, BiConsumer<Iterable<T>,
            Iterable<T>> iterableAssertion) {
        return new TestMatcher<T>(clazz, assertion, iterableAssertion);
    }
