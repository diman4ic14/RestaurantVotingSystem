...
<nav class="navbar navbar-expand-md navbar-dark bg-dark py-0">
    <div class="container">
        <a href="dishes" class="navbar-brand"><img src="resources/images/icon-rating.png"> Restaurant Voting System</a>
                ...
                <li class="nav-item">
                    <sec:authorize access="isAuthenticated()">
                        <form:form class="form-inline my-2" action="logout" method="post">
                            <a class="btn btn-info mr-1" href="dishes"><spring:message code="dish.title"/></a>
